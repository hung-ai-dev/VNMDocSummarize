...
vietnamese = """
bị bởi cả các cái cần càng chỉ chiếc cho chứ chưa chuyện có có_thể cứ của cùng cũng đã đang đây để đến_nỗi đều điều do đó
được dưới gì khi không là lại lên lúc mà mỗi một_cách này nên nếu ngay nhiều như nhưng những nơi nữa phải qua ra rằng
rằng rất rất rồi sau sẽ so sự tại theo thì trên trước từ từng và vẫn vào vậy vì việc với vừa
"""
